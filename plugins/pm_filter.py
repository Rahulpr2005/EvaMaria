...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('<b>എടാ ചെക്കാ, പടം കാണാനില്ലലോ 🤔 !! പടം റിലീസ് അയൊന്നു ഒന്നുടെ ചെക്ക് ചെയ്യൂ 🥱....</b>')
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>എന്റെ മോനെ നീ ചോയ്ച്ച പടം ഞൻ കുറെ തപ്പി.... അവസാനം കിട്ടി ട്ടാ 😇....</b>"
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("<b>എടാ ചെക്കാ, പടം കാണാനില്ലലോ 🤔 !! പടം റിലീസ് അയൊന്നു ഒന്നുടെ ചെക്ക് ചെയ്യൂ 🥱....</b>")
        await asyncio.sleep(8)
        await k.delete()
        return
    ...
    await msg.reply("<b>ഇതിൽ വല്ലതും ആണോ ഉദ്ദേശിച്ചത് 😇?.... </b>",
                    reply_markup=InlineKeyboardMarkup(btn))
